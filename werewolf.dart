...
void main(List<String> arg) {
  ...
  if (input == "werewolf") {
    if (input == "") {
      ...
      print(
          "Karakter yang kamu pilih adalah Witch, Gunakan kekuatan magic kamu untuk mengetahui siapa Werewolf nya");
    } else if (input == "guardian") {
      print(
          "Karakter yang kamu pilih adalah Guardian, Selamatkan warga ketika Werewolf menyerang");
    } else if (input == "villager") {
      print(
          "Karakter yang kamu pilih adalah Villager, Kabur lah ketika kamu mendengar suara dari Werewolf");
    } else if (input == "info") {
      print(
